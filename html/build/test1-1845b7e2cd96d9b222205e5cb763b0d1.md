...
## Citations
Citations are important and there are a few ways to insert citations in myst markdown formatted papers. The easiest way is to locate the DOI of the paper say from [crossref.org](https://www.crossref.org) and insert the DOI.  Like this `[](doi url)` will produce something like as follows
